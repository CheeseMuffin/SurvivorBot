...
class Battle {
	...
	move(turn) {
		...
		/*for (let i = 0; i < this.moves.length; i++) {
			console.log(this.moves[i] + " ! " + this.effectiveBasePower(this.moves[i]));
		}*/
	...
	effectiveBasePower(move) {
		...
		let realOppMon = Tools.data.pokedex[Tools.toId(this.oppMon)];
	...
	effectiveness(move, mon) {
		let realMove = Tools.data.moves[realMove];
		//let realMon = 
	}
